class PhotosController < ApplicationController
  ...
  def create
    @photo = @gallery.photos.new(
        ...
        :width         => params[:width],
        :color_one_id  => params[:select][:color1],
        :color_two_id  => params[:select][:color2],
        :rubrik_one_id => params[:select][:rubrik1],
        :rubrik_two_id => params[:select][:rubrik2],
        :tags          => params[:tags],
        ...
        :decor_one_id  => params[:select][:decor_one],
        :decor_two_id  => params[:select][:decor_two],
        :decor_three_id=> params[:select][:decor_three],
